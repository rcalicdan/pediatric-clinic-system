<section class="w-full">
    <x-contents.heading title="Consultation Records" />
    ...
    <x-contents.layout>
        <div x-data="{ isSearchModalOpen: false }" @search-completed.window="isSearchModalOpen = false"
            ...
            <x-contents.table-head>
                <x-utils.search-button searchButtonName="Search Consultations" />
            </x-contents.table-head>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-100 transition-colors duration-150 ease-in-out">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                ...
                                <div class="text-xs text-gray-500">{{ ucfirst($consultation->doctor->role) }}</div>
                            </td>
            ...
            <!-- Search Modal -->
            <x-modals.search-form title="Search Consultations" :isSearchModalOpen="$isSearchModalOpen">
                <div>
                ...
                <div>
                    <label for="search-doctor-name" class="block text-sm font-medium text-gray-700">Doctor Name</label>
                    <input type="text" id="search-doctor-name" wire:model='searchDoctorName'
                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
