<section class="w-full">
    <x-contents.heading title="Update Patient" />
    ...
    <x-contents.layout>
        <div class="p-4 sm:p-6 lg:p-8">
            ...
            @if ($currentStep === 1)
                <!-- Guardian Form -->
                <form wire:submit.prevent='updateGuardian' class="space-y-6">
                    ...
                    <div class="flex justify-end">
                        <x-utils.submit-button wire-target="updateGuardian" button-text="Next: Patient Information" />
                        <x-utils.link-button :href="route('patients.index')" button-text="Cancel" />
                    </div>
                </form>
            @endif
                ...
                <form wire:submit.prevent='updatePatient' class="space-y-6">
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="flex space-x-2">
                            <x-utils.submit-button wire-target="updatePatient" button-text="Update Patient" />
                            <x-utils.link-button :href="route('patients.index')" button-text="Cancel" />
                        </div>
                    </div>
                </form>
